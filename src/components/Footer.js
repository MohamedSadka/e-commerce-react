const Footer = () => {
  return (
    <div className="footer">
      <div className="footer-details d-flex px-3 ">
        <div className="row">
          <h4 className="row-title">Exclusive</h4>
          <p>subscribe</p>
        ...
        <div className="row">
          <h6 className="row-title">Support</h6>
          <p>111 Bijoy sarani, Dhaka, DH 1515, Bangladesh.</p>
          <p>exclusive@gmail.com</p>
          <p>+88015-88888-9999</p>
        </div>
        <div className="row">
          <h6 className="row-title">Account</h6>
          <p>My Account</p>
          <p>Login / Register</p>
          <p>Cart</p>
          <p>Wishlist</p>
        ...
        <div className="row">
          <h6 className="row-title">Quick Link</h6>
          <p>Privacy Policy</p>
          <p>Terms Of Use</p>
          <p>FAQ</p>
          <p>Contact</p>
        ...
        <div className="row">
          <h6 className="row-title">Download App</h6>
          <span>Save $3 with App New User Only</span>
          <div className="d-flex align-center gap-3 mt-3 mb-3">
            <img className="qr-img" src="/images/qr-code.jpeg" alt="qr-code" />
            <div className="social-icons">
              ...
              className="googleplay-img"
                ...
                alt="google play"
              />
              <img className="appstore-img" src="/images/app-store.png" alt="app-store" />
            </div>
          </div>
